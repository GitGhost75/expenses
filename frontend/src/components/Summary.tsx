...
export function Summary({ billings, people, expenses }: SummaryProps) {
  if (billings.length === 0 && expenses.length === 0) {
    return (
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-4">
        <div className="bg-blue-50 p-4 rounded-lg">
          <h3 className="font-semibold text-blue-800 mb-2 text-sm lg:text-xl">Gesamt</h3>
          <p className="text-2xl font-bold text-blue-600  sm:scale-100 scale-[0.8]">{totalExpenses.toFixed(2)}€</p>
        </div>
        {/* <div className="bg-green-50 p-4 rounded-lg">
          <h3 className="font-semibold text-green-800 mb-2 text-sm lg:text-xl">Pro Person</h3>
